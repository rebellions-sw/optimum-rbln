...
from ..decoderonly.modeling_decoderonly import RBLNRBLNDecoderOnlyForCausalLMOutput
...
class RBLNLlavaNextForConditionalGeneration(RBLNModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return RBLNRBLNDecoderOnlyForCausalLMOutput(logits=logits, generate_idx=generate_idx)
