...
class RBLNFluxTransformer2DModelConfig(RBLNModelConfig):
    """
    Configuration class for RBLN Flux Transformer models.

    This class inherits from RBLNModelConfig and provides specific configuration options
    for Transformer models used in Flux models.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            max_sequence_length (Optional[int]): The maximum sequence length for the transformer model.
