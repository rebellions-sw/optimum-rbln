...
from .deformable_detr_architecture import DeformableDetrForObjectDetectionWrapper
...
class RBLNDeformableDetrForObjectDetection(RBLNModel):
    auto_model_class = AutoModelForObjectDetection
    _model_wrapper_cls = DeformableDetrForObjectDetectionWrapper

    @classmethod
    def wrap_model_if_needed(cls, model: "PreTrainedModel", rbln_config: "RBLNConfig"):
        return cls._model_wrapper_cls(model).eval()
