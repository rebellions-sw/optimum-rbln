...
from transformers import (
    ...
    PretrainedConfig,
    PreTrainedModel,
    ColQwen2_5ForConditionalGeneration,
)
from transformers.modeling_utils import no_init_weights
from transformers.models.colqwen2_5.modeling_colqwen2_5 import (
    Qwen2_5_VisionPatchEmbed,
    Qwen2_5_VisionRotaryEmbedding,
    Qwen2_5_VisionTransformerPretrainedModel,
    ColQwen2_5RotaryEmbedding,
)
...
class RBLNQwen2_5_VisionTransformerPretrainedModel(RBLNModel):
    ...
    def save_torch_artifacts(
        cls,
        model: "ColQwen2_5ForConditionalGeneration",
        save_dir_path: Path,
        subfolder: str,
...
class RBLNColQwen2_5ForConditionalGeneration(RBLNDecoderOnlyModelForCausalLM):
    ...
    def __post_init__(self, **kwargs):
        ...
        self.rotary_emb = ColQwen2_5RotaryEmbedding(self.config)
