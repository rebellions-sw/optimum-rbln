...
class RBLNCosmos2TextToImagePipeline(RBLNDiffusionMixin, Cosmos2TextToImagePipeline):
    """
    RBLN-accelerated implementation of Cosmos Predict2 Text to Image pipeline for text-to-image generation.

    This pipeline compiles Cosmos Predict2 Text to Image models to run efficiently on RBLN NPUs, enabling high-performance
    inference for generating images that follow physical laws with enhanced visual quality.
    """

    original_class = Cosmos2TextToImagePipeline
