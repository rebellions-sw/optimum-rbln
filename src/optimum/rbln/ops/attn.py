...
def add_softmax_attn_decode(
    q: Tensor, k: Tensor, v: Tensor, mask: Tensor, kcache: Tensor, vcache: Tensor, seq: Tensor, scale: Tensor
) -> Tensor:
    """Defines the computation pattern for fused attention with KV cache updates.
...
@add_softmax_attn_decode.register_fake
def add_softmax_attn_decode_fake(
    q: Tensor,
    k: Tensor,
    v: Tensor,
    mask: Tensor,
