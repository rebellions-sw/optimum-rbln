    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        Raises:
            ...
            ValueError: If the visual configuration is provided but contains invalid settings, such as an invalid max_seq_len (e.g., not a positive integer or insufficient for the expected resolution).
